sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("vesi/fi/rfi/yfi_dfi_rfi/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("vesi.fi.rfi.yfi_dfi_rfi.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["vesi/fi/rfi/yfi_dfi_rfi/localService/mockserver"], function (mockserver) {
