sap.ui.define([
		...
		return BaseObject.extend("vesi.fi.rfi.yfi_dfi_rfi.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias vesi.fi.rfi.yfi_dfi_rfi.model.ListSelector
			 */
			 ...
			 * @return {vesi.fi.rfi.yfi_dfi_rfi.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
